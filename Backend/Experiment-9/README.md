...
- **Basic Authentication**: Uses HTTP Basic Auth where credentials are sent in the Authorization header encoded in Base64.
- **Simple Token Authentication**: A custom implementation where a token is generated and validated using Base64 encoding.
- **JWT Authentication**: Uses JSON Web Tokens for stateless authentication, providing better security and scalability.
